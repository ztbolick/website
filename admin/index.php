  ...
  <body id="LoginForm">
    <div class="container">
      <div class="login-form row">
        <div class="main-div col-xl-3 col-lg-3 px-3 p-4">
          <div class="panel">
          ...
          <form id="Login" action = "includes/login.php" method="post">
            ...
            <div class="form-group">
              <input type="password" class="form-control" id="inputPassword" name="pword" placeholder="Password">
            </div>
            <div class="forgot">
              <a href="reset.html">Forgot password?</a><br>
            </div>
            <button type="submit" name="submit" value="log in" class="btn btn-primary">Login</button>
            <div class="register">
              <br>
              <p>Not yet a user?</p>
